...
import { createDatabase, DrizzleAssetWorkspaceRepository, DrizzleControlPlaneRepository, DrizzleTaskRunRepository } from "@alchemy-video/persistence";
...
const app = createApp({ store, assetStore, taskStore, storage });
