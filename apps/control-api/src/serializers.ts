...
export const serializeStoryboardRevision = (storyboard: ControlStoryboardRevision) => ({
  ...
  shot_specs: storyboard.shotSpecs.map((shotSpec) => ({
    ...
    ...(shotSpec.startState ? { start_state: shotSpec.startState } : {}),
    ...(shotSpec.endState ? { end_state: shotSpec.endState } : {}),
    ...(shotSpec.transitionSummary ? { transition_summary: shotSpec.transitionSummary } : {}),
    reference_policy: shotSpec.referencePolicy,
    depends_on_sequences: shotSpec.dependsOnSequences,
    ...(shotSpec.continuityNote ? { continuity_note: shotSpec.continuityNote } : {}),
